...
class FileTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->fileDTO->type = FileClass::TYPE_BINARY;
        ...
        $this->file = new FileClass($this->fileDTO, $this->model_1::getModelName(), 'local', 'qwerty');
    }

    public function testConstructEmptyPrefixAndTag()
    {
        $file = new FileClass($this->fileDTO, $this->model_1::getModelName(), 'local');
    ...
    {
        $this->assertEquals(FileClass::TYPE_BINARY, $this->file->getType());
    }
