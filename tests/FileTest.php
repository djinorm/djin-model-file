...
class FileTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->fileDTO->type = MyFile::TYPE_BINARY;
        ...
        $this->file = new MyFile($this->fileDTO, $this->model_1::getModelName(), 'local', 'qwerty');
    }

    public function testConstructEmptyPrefixAndTag()
    {
        $file = new MyFile($this->fileDTO, $this->model_1::getModelName(), 'local');
    ...
    {
        $this->assertEquals(MyFile::TYPE_BINARY, $this->file->getType());
    }
